 ...
 *   https://datatables.net/download/#bs5/dt-2.2.2/date-1.5.5/fh-4.0.1/r-3.0.4/sp-2.3.3
 *
 * Included libraries:
 *   DataTables 2.2.2, DateTime 1.5.5, FixedHeader 4.0.1, Responsive 3.0.4, SearchPanes 2.3.3
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs5/dt-2.2.2/date-1.5.5/fh-4.0.1/r-3.0.4/sp-2.3.3",
